...
STATS_GROUP_FILE_PATH = json_file.get("statsGroupFilePath")
...
END_STRING_GROUP = json_file.get("endStringGroup")
SHOULD_WRITE_STATS_GROUP_FILE = json_file.get("writeStatsGroupFile")