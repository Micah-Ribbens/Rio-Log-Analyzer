...
keyboard_keys_to_game_engine_keys = {
    ...
    KEY_UP: pygame.K_UP,
    KEY_DOWN: pygame.K_DOWN,
    KEY_QUESTION_MARK: pygame.K_SLASH,
    ...
    KEY_SPACE_BAR: pygame.K_SPACE
}

keys = [KEY_A, KEY_B, KEY_C, KEY_D, KEY_E, KEY_F, KEY_G, KEY_H, KEY_I, KEY_J, KEY_K, KEY_L, KEY_M, KEY_N, KEY_O, KEY_P, KEY_Q, KEY_R, KEY_S, KEY_T, KEY_U, KEY_V, KEY_W, KEY_X, KEY_Y, KEY_Z, KEY_LEFT, KEY_RIGHT, KEY_UP, KEY_DOWN, KEY_QUESTION_MARK, KEY_PERIOD, KEY_COMMA, KEY_COLON, KEY_QUOTATION_MARKS, KEY_LEFT_BRACKET, KEY_RIGHT_BRACKET, KEY_ESCAPE, KEY_SPACE_BAR]
